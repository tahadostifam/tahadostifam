...
### Skills
[![My Skills](https://skillicons.dev/icons?i=vscode,js,ts,react,nodejs,express,jest,cpp,cmake,py,linux,docker,nginx,bash,git,github,gitlab,postgres,sqlite,mongodb,redis)](https://skillicons.dev)
