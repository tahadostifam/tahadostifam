...
### Skills
[![My Skills](https://skillicons.dev/icons?i=vscode,js,ts,nodejs,express,jest,cpp,cmake,linux,docker,nginx,bash,git,github,gitlab,postgres,sqlite,mongodb,redis)](https://skillicons.dev)
